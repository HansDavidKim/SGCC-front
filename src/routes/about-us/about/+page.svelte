...
<main>
  <div class="flex relative justify-center bg-black h-[1437px] text-white">
    ...
    <p class="absolute top-[262px] text-[18px] leading-[40px] font-medium text-center">
      ...
      <br>
      SGGCC는 컴퓨터에 대한 다양한 분야를 체험할 수 있으며, 초심자에게 매우 친화적인 플랫폼입니다.<br>
      부원들은 매학기 SGCC에서 운영하는 기초 프로그래밍 스터디 및 심화 세미나를 통해 함께 학습하며 성장해 나갈 수 있습니다.<br>
      뿐만 아니라, 슬기로운 인디 생활 등 정기적으로 프로젝트를 진행하며 협업의 장으로서 활발하게 활동하고 있습니다.
    </p>

    <div class="absolute top-[580px] w-[1472px] h-[722px] bg-white">
